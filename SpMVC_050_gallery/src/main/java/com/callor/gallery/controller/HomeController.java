...
public class HomeController {
	...
	// Request를 처리할 method
	// a tag를 클릭했을때
	// 		<a href="${rootPath}/dummy/gallery/detail">클릭</a>
	// 주소창에 직접 입력하고 Enter를 눌렀을때
	// 		localhost:8080/rootPath/dummy/gallery/detail
	// location.href=${rootPath}/dummy/gallery/detail 로 JS에서 실행했을때
	...
	// Request를 처리할 method
	/*
	 * <form action="${rootPath}/dummy/gallery/detail"
	 * 		method="POST">
	 * 		<input name="str">
	 ...
	 * 		input box에 어떤 문자열을 입력한 후 전송 button을 클릭하면
	 * 이 method가 Request를 수신하고
	 * 		input box에 입력한 문자열은 str 변수에 담기게 된다.
	 */
	@RequestMapping(value = "/dummy/gallery/detail/image", method = RequestMethod.POST)
...
//		model.addAttribute("file", fileName);
	 ...
	 * 이 클래스에 @RequestParam을 부이면 400오류가 난다.
	 */
	...
	public String home(
		...
		/*
		 * 다수의 파일이 업로드 되면 파일들의 정보가 m_file 객체에 담기게 된다
		 * 
