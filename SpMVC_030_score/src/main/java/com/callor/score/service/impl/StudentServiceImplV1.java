...
public class StudentServiceImplV1 implements StudentService {
	...
	public String makeStNum(String prefix) {
		...
		// %d : 10진수의 형식설정, %s : String의 형식설정, %04d : 10진수의 4자릿수를 만들어주고 모자란 자리는 0으로 채워준다  
	 ...
	 * 그중 CUD가 진행되는 동안 문제가 발생하고 데이터가 오류가 저장될 것이다.
	 * 
	 * 이런 상황을 방지 하기 위하여 업무 단위를 Transaction이라는 단위로 묶고
	 * 
	...
	public String scoreInput(ScoreInputVO scInputVO) {
		...
		*/
		 ...
		 * 
		 * 그랬더니 transactionManager에 의해서 모든 Insert Or Update가 Rollback 되어버렸다.
		 */
